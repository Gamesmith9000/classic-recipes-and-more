...
# [NOTE] This uses sandbox items
# [NOTE] ENV variables for client id and client secret ARE values for the sandbox
# Source: https://developer.paypal.com/docs/checkout/reference/server-integration/setup-sdk/
